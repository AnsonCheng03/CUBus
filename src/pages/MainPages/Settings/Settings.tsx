            ...
            {appData.WebsiteLinks.map((row: any) => {
              if (row[0][lang]) {
                return (
                  <IonItem
                    key={row[0][lang]}
                    onClick={() => window.open(row[1])}
                  >
                    <IonLabel>{row[0][lang]}</IonLabel>
                  </IonItem>
                );
              }
            })}
              ...
              <div className="option-expand">
                <div className="option-expand-wrapper">
                  <div className="option-expand-content">
                    ...
                    <br />
                    <br />
                    This website records visitor numbers and basic usage
                    patterns every time you visit. Some of this information and
                    your personalized data are collected through cookies. A
                    cookie is a small information file that is automatically
                    stored in the visitor's browser on their computer and can be
                    read by this website. Whenever a user accesses this website,
                    the server log file automatically identifies and records the
                    visitor's IP address, visit date and time, and the total
                    number of pages viewed. Your internet service provider
                    automatically assigns an IP address to your computer or
                    other electronic device. Collecting IP addresses is a common
                    practice on the internet, and many websites do this
                    automatically. IP addresses are used for various purposes,
                    including monitoring website traffic, diagnosing server
                    issues, providing you with a more personalized online and
                    offline experience, managing the website, and/or improving
                    compliance and security levels. This information is retained
                    for only seven days. This webpage stores most of the data
                    input by users, such as destination and submission time, but
                    personally identifiable information like user IP addresses
                    is not linked to the input data, so users cannot be directly
                    identified by their input. This data will be used for
                    purposes such as adjusting bus schedules and service times,
                    with details available in the website's source code. None of
                    the user's data will be sold. Web pages related to CUSIS
                    services are not included in the data collection scope, and
                    all user data on these pages will not be stored. This
                    webpage uses services from multiple companies for
                    advertising and data analysis, including Google Analytics,
                    Skimlinks, Cloudflare, and PropellerAds. For detailed
                    information, please refer to the privacy statements of each
                    organization. The website's privacy statement is updated
                    periodically. To ensure you are familiar with the latest
                    version of the content, please check this webpage
                    frequently.
                  </div>
                </div>
              </div>
                ...
                <div className="option-expand-wrapper">
                  <div className="option-expand-content">
                    ...
                    <ul>
                      ...
                      <li>
                        智能篩選服務時間外之校巴:避免中大學生查到無效資訊。
                      </li>
                      <li>
                        預覽功能:中大學生可提前查看未來某日的校巴路線安排。
                      </li>
                      <li>
